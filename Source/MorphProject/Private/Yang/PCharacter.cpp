...
APCharacter::APCharacter()
{
	...
	SpringArmComp->bUsePawnControlRotation = true;// camera use controller rotation
	...
	bUseControllerRotationYaw = false;//disable character automatically use camera yaw rotation
}
